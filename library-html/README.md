...
It's in the XML module because JSOUP can query via XPath.
...
* The YUI Compressor is written in Java (requires Java >= 1.4) and relies on Rhino to tokenize the source JavaScript
  file.
* [Compiler - JavaScript optimizer](https://developers.google.com/closure/compiler). It compiles from JavaScript to
  better JavaScript. It parses your JavaScript, analyzes it, removes dead code and rewrites and minimizes what's left.
